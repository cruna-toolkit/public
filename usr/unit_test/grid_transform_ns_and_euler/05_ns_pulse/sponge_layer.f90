...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    if(.not.allocated(sponge_function)) then
       ...
       x_min = x10 + len
       x_max = x10
       sigma = (((X(:,:,:,1) - x_min)/(x_max - x_min))**2) - 1.0_rk
       where(X(:,:,:,1) > x_min ) sigma = -1.0_rk
       ...
       x_min = x20 + len
       x_max = x20
       sigma = (((X(:,:,:,2) - x_min)/(x_max - x_min))**2) - 1.0_rk
       where(X(:,:,:,2) > x_min ) sigma = -1.0_rk
       sponge_function = sponge_function * abs(sigma)
       ...
       x_min = x30 + len
       x_max = x30
       sigma = (((X(:,:,:,3) - x_min)/(x_max - x_min))**2) - 1.0_rk
       where(X(:,:,:,3) > x_min ) sigma = -1.0_rk
       sponge_function = sponge_function * abs(sigma)
