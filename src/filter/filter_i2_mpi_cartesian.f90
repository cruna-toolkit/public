module filter_i2_mpi_cartesian

  use parameter
  use filter_x_core           , only: filter_core  => filter_i2 , filter_i2_name => filter_i2_name , filter_i2_type => filter_i2_type
...
end module filter_i2_mpi_cartesian
