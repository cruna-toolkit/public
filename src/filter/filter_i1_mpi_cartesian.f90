module filter_i1_mpi_cartesian

  use parameter
  use filter_x_core           , only: filter_core  => filter_i1 , filter_i1_name => filter_i1_name , filter_i1_type => filter_i1_type
...
end module filter_i1_mpi_cartesian
