module filter_weighted_i1_mpi_cartesian
 
  use parameter
  use filter_weighted_x_core  , only: filter_core  => filter_i1 , filter_i1_name => filter_i1_name , filter_i1_type => filter_i1_type , init_filter => init_filter
  use transpose_mpi_cartesian , only: ftranspose => ftranspose_i1, btranspose => btranspose_i1
  USE mpi
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    do i = 1,size(q,4)
       ...
       ! strength and weight
       fries_2d = strength_2d * weight_2d * fries_2d
       ! 2nd call
       call filter_core(fries_2d)
       fries_2d = fries_2d/weight_2d
...
end module filter_weighted_i1_mpi_cartesian
