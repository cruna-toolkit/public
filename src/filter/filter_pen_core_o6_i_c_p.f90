module filter_pen_core_o6_i_c_p
  ...
  character(len=max_length_parameter), parameter, public :: filter_name = 'filter_pen_core_o6_i_c_p'
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    q_tmp( 1,:) = a0*q(1,:) + a1*(q(2,:) + q(n1,:)) + a2*(q(3,:) + q(n1-1,:)) + a3*(q(4,:) + q(n1-2,:))
    q_tmp( 2,:) = a0*q(2,:) + a1*(q(3,:) + q(1 ,:)) + a2*(q(4,:) + q(n1  ,:)) + a3*(q(5,:) + q(n1-1,:))
    q_tmp( 3,:) = a0*q(3,:) + a1*(q(4,:) + q(2 ,:)) + a2*(q(5,:) + q(1   ,:)) + a3*(q(6,:) + q(n1  ,:))

    q_tmp(n1  ,:) = a0*q(n1  ,:) + a1*(q( 1  ,:) + q(n1-1,:)) + a2*(q(2 ,:) + q(n1-2,:)) + a3*(q(3,:) + q(n1-3,:))
    q_tmp(n1-1,:) = a0*q(n1-1,:) + a1*(q(n1  ,:) + q(n1-2,:)) + a2*(q(1 ,:) + q(n1-3,:)) + a3*(q(2,:) + q(n1-4,:))
    q_tmp(n1-2,:) = a0*q(n1-2,:) + a1*(q(n1-1,:) + q(n1-3,:)) + a2*(q(n1,:) + q(n1-4,:)) + a3*(q(1,:) + q(n1-5,:))
...
end module filter_pen_core_o6_i_c_p
