module diff_pen_core_o4_i_c_p_pade
  ...
  character(len=max_length_parameter), parameter, public :: diff_name = 'diff_pen_core_o4_i_c_p_pade'
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    if(info.ne.0) then
       write(*,*) "error in diff_pen_core_o4_i_c_p_pade.f90:diff_main:error with id: ",info
    end if
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    if(info.ne.0) then
       write(*,*) "error in diff_pen_core_o4_i_c_p_pade.f90:init_left_implicit_diff_part:error with id: ",info
    end if
...
end module diff_pen_core_o4_i_c_p_pade
