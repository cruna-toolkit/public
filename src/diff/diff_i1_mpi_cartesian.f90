module diff_i1_mpi_cartesian

  use parameter
  use discretisation_x_core   , only: diff_core  => diff_i1 , diff_i1_name => diff_i1_name , diff_i1_type => diff_i1_type
...
end module diff_i1_mpi_cartesian
