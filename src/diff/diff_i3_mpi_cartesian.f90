module diff_i3_mpi_cartesian

  use parameter
  use discretisation_x_core   , only: diff_core  => diff_i3 , diff_i3_name => diff_i3_name , diff_i3_type => diff_i3_type
...
end module diff_i3_mpi_cartesian
