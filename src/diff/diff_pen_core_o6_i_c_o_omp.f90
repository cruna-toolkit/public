module diff_pen_core_o6_i_c_o_omp
  ...
  character(len=max_length_parameter), parameter, public :: diff_name = 'diff_pen_core_o6_i_c_o_omp'
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    !$omp parallel num_threads(tnr) shared(q) private(q_1,i) firstprivate(dx,stencil,dl,dc,du,du2,ipiv)
    !$omp do schedule(dynamic)
    do i = 1,size(q,2)
       q_1(:,1) = q(:,i)
       call diff_main(q_1,dx,stencil,dl,dc,du,du2,ipiv)
       q(:,i) = q_1(:,1)
    end do
    !$omp end do
    !$omp end parallel
...
end module diff_pen_core_o6_i_c_o_omp
